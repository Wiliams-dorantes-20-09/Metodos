...
namespace WindowsFormsApplication1
{
    public partial class Simplex : Form
    {
        ...
        private void buttonOk_Click(object sender, EventArgs e)
        {
            ...
            label_coef.Text = "Función objetivo a maximizar:";
            ...
            label_const.Text = "Restricciones:";
        ...
        label1: PrintTable();
            ...
            else
            {
                ...
                lab.Location = new System.Drawing.Point(x, y);
                lab.AutoSize = true;
                lab.Text = "Elemento guía:" + matrix[guiding_row, guiding_column];
                Controls.Add(lab);
