...
namespace WindowsFormsApplication1
{
    public partial class transporte : Form
    {
        ...
        private void solveProblemAndDisplay(TransportProblem p)
        {
            ...
            sHTML += "Problema equilibrado: " + p.isBalanced + "</br>";
            if (!p.isBalanced)
            {
                sHTML += "El problema del transporte no está equilibrado!" + "</br>";
                sHTML += "Proveedores: " + p.Suppliers.Sum() + "</br>";
                sHTML += "demandantes: " + p.Demanders.Sum() + "</br>";
            }
            #endregion
            ...
            if (p.isBalanced)
            {
                ...
                sHTML += "<b>Solución: método del noroeste</b>" + "</br>";
                sHTML += "Costo: " + costNorthWest + "</br>";
                ...
                sHTML += "<b>Solución: método del elemento de costo mínimo</b>" + "</br>";
                sHTML += "Costo: " + costMinimumCostElement + "</br>";
                ...
                sHTML += "<b>Solución: optimización de mínimos potenciales</b>" + "</br>";
                sHTML += "Cost: " + costUV + "</br>";
                sHTML += "Ciclos: " + cycles + "</br>";
    ...
    public class TransportProblem
    {
            ...
            set
            {
                ...
                if (value != null)
                    if (value.Length != suppliers.Length)
                        throw new ArgumentException("El tamaño de la matriz debe ser el mismo.");
        ...
        public double calculateCost(double[,] solution)
        {
            ...
            { throw new ArgumentException("La matriz de soluciones debe tener las mismas dimensiones que la matriz de costos"); }
